package com.drosapp.web.rest;

import com.drosapp.MyappApp;
import com.drosapp.config.TestSecurityConfiguration;
import com.drosapp.domain.JobHistory;
import com.drosapp.repository.JobHistoryRepository;
import com.drosapp.repository.search.JobHistorySearchRepository;
import com.drosapp.service.JobHistoryService;
import com.drosapp.web.rest.errors.ExceptionTranslator;
...
import static com.drosapp.web.rest.TestUtil.createFormattingConversionService;
...
import com.drosapp.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.drosapp.repository.search test package.
     *
     * @see com.drosapp.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
